function plot_stewart_fk(P_base, P_top, hrr, hrl, hfl, hfr, phi_rad, theta_rad)
    ...
    figure('Position', [100, 100, 1400, 800], 'Name', 'Stewart Platform Forward Kinematics');
    ...
    title('Forward Kinematics', 'FontSize', 16, 'FontWeight', 'bold');
